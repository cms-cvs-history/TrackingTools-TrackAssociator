...
#        'file:/afs/cern.ch/cms/fireworks/tmp/reco_CosmicMC_BON_EcalAPD200_FullReadout_TKOnly_RECOSIM_01.root'
	'file:/afs/cern.ch/cms/fireworks/tmp/PYTHIA6_EWK_Zmumu_10TeV_cff_py_RAW2DIGI_RECO.root'
    )
)
